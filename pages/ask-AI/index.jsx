...
const AskAI = () => {
  ...
  return (
    <div>
      ...
      <div className=" border border-purple-gray mx-60 h-[450px] mt-7 rounded-xl overflow-y-auto">
        {loader ? (
      ...
      <div className="absolute bottom-5 w-full">
        <label className="flex gap-2 flex-row form-control mx-60">
          <input
            ...
            required
            className="input input-bordered border-purple w-full text-black"
          />
          <button
            className="btn text-white bg-purple hover:bg-[#7B69DF]"
